...
const Beliefs = () => {
    ...
    //   <p className="mt-6 max-w-4xl text-2xl font-small text-gray-500">We are passionate about preserving our planet's green treasures. Through collaborative efforts, we strive to protect and nurture trees, ensuring a sustainable and beautiful environment for generations to come. Join us in our mission to make the world a greener and healthier place.</p>
    // </div>
    )
}
