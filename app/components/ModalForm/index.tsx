...
interface AuthenticationModalProps {
  ...
  const AuthenticationModal: React.FC<AuthenticationModalProps> = ({ isOpen, closeModal }) => {
    ...
    const handlePayment = async () => {
      ...
      const numericAmount = parseFloat(amount); // Convert the amount to a numeric value
          ...
          <div className="relative w-full max-w-md max-h-full">
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div className="px-6 py-6 lg:px-8">
                <h3 className="mb-4 text-xl font-medium text-lacoste dark:text-green">Enter Your Details</h3>
