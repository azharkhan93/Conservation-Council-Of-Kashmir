          ...
          <div className="grid gap-6 px-4 sm:px-0 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            ...
            {/* <div className="group relative rounded-3xl  space-y-6 overflow-hidden">
              <img
                ...
                height="805"
              /> */}
              {/* <div className="absolute bottom-0 inset-x-0 h-max mt-auto px-8 py-6 bg-gray-800 dark:bg-greentranslate-y-24 transition duration-300 ease-in-out group-hover:translate-y-0">
                <div>
                  <h4 className="text-xl font-semibold dark:text-gray-700 text-white">Hentoni Doe</h4>
                  <span className="block text-sm text-gray-500">CEO-Founder</span>
                </div>
